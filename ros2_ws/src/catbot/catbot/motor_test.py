...
class MotorTest(Node):
    def __init__(self):
        ...
        self.control0 = self.create_publisher(ControlMessage, '/odrive_axis0/control_message', 10)
        self.control1 = self.create_publisher(ControlMessage, '/odrive_axis1/control_message', 10)
        self.timer = self.create_timer(0.1, self.control_message)
    
    def control_message(self):
        # /odrive_axis0/
        self.control_msg.input_vel = 2.0
        self.control0.publish(self.control_msg)
        
        # /odrive_axis1/
        self.control_msg.input_vel = 1.0
        self.control1.publish(self.control_msg)
