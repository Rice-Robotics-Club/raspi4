...
class ControlNode(Node):
    def __init__(self):
        ...
        self.motor_msg1.input_pos = 0.0
        self.motor_msg1.input_vel = 0.0
        self.motor_msg1.input_torque = 0.0
        # Bottom Motor
        ...
        self.motor_msg2.input_pos = 0.0
        self.motor_msg2.input_vel = 0.0
        self.motor_msg2.input_torque = 0.0
    ...
    def check_and_update_phase(self):
        if self.zero_angle1 is not None and self.zero_angle2 is not None:
            self.get_logger().info('Both motor zero angles are set. Starting the jumping sequence.')
            self.start_proning_phase()
    ...
    def proning_phase(self):
        ...
        self.transition_timer = self.create_timer(2, self.transition_to_poising)
    ...
    def poising_phase(self):
        ...
        self.transition_timer = self.create_timer(0.5, self.transition_to_pouncing)
    ...
    def pouncing_phase(self):
        ...
        self.transition_timer = self.create_timer(1, self.transition_to_bracing) 
    ...
    def bracing_phase(self):
        ...
        self.transition_timer = self.create_timer(1, self.transition_to_landing)  
